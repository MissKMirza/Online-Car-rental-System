...
5. Requires a MySQL database, so create a database with the name given under the settings.py file.
6. Then, make database migrations: python manage.py makemigrations
7. python manage.py migrate
8. And finally, after a successful migration run, the application: python manage.py runserver
